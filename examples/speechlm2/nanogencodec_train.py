...
from nemo.collections.speechlm2.models.nanogencodec import NanoGenCodec
...
@hydra_runner(config_path="conf", config_name="nanogencodec")
def train(cfg):
    ...
    with trainer.init_module():
        model = NanoGenCodec(OmegaConf.to_container(cfg, resolve=True))
    ...
    dataset = DuplexEARTTSDataset(
        ...
        add_text_bos_and_eos_in_each_turn=cfg.data.get("add_text_bos_and_eos_in_each_turn", False),
        add_audio_prompt=cfg.data.get("add_audio_prompt", False),
