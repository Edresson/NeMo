# Adapted from https://github.com/Stability-AI/stable-audio-tools/blob/8040f2adbb20811a17ae618c20b7c48ceaa4c948/stable_audio_tools/models/encodec.py under MIT License
...
class DiscriminatorSTFT(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        for i, layer in enumerate(self.convs):
            ...
            z = self.activation(z)
            fmap.append(z.squeeze(1))
        z = checkpoint(self.conv_post, z)
        return z.squeeze(1), fmap
...
class MultiScaleSTFTDiscriminator(nn.Module):
    ...
    def forward(self, audio_real, audio_gen):
        ...
        for disc in self.discriminators:
            score_real, fmap_real = disc(x=audio_real.unsqueeze(1))
            scores_real.append(score_real)
            fmaps_real.append(fmap_real)

            score_gen, fmap_gen = disc(x=audio_gen.unsqueeze(1))
